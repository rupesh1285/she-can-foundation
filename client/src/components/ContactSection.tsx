...
export const ContactSection = () => {
  ...
  const inputClasses = "w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-[#E11D48] focus:ring-4 focus:ring-[#FFE4E6] transition-all bg-white text-gray-800 font-medium placeholder:text-gray-400";
    ...
    <section id="contact" className="py-24 bg-white relative">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold font-serif text-[#0F172A] mb-4">Get in Touch</h2>
        ...
        <div className="flex flex-col lg:flex-row bg-[#FFE4E6]/10 rounded-[3rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-[#FFE4E6]/50 overflow-hidden">
          
          <div className="lg:w-2/5 relative overflow-hidden group p-10 md:p-14 text-white flex flex-col">
            <div className="absolute inset-0 bg-gradient-to-br from-[#E11D48] to-[#0F172A] z-0 transition-transform duration-700 group-hover:scale-105"></div>
            <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl z-10"></div>
            <div className="absolute bottom-[-20%] left-[-20%] w-80 h-80 bg-[#FDA4AF]/20 rounded-full blur-3xl z-10"></div>
              ...
              <div className="space-y-8">
                <motion.div whileHover={{ x: 5 }} className="flex items-start gap-5">
                  <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl shadow-[inset_0_0_10px_rgba(255,255,255,0.2)]">
                    <Mail size={24} className="text-[#FFE4E6]" />
                  </div>
                  <div>
                ...
                <motion.div whileHover={{ x: 5 }} className="flex items-start gap-5">
                  <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl shadow-[inset_0_0_10px_rgba(255,255,255,0.2)]">
                    <MapPin size={24} className="text-[#FFE4E6]" />
                  </div>
                  <div>
                ...
                <motion.div whileHover={{ x: 5 }} className="flex items-start gap-5">
                  <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl shadow-[inset_0_0_10px_rgba(255,255,255,0.2)]">
                    <Phone size={24} className="text-[#FFE4E6]" />
                  </div>
                  <div>
          ...
          <div className="lg:w-3/5 p-10 md:p-14 lg:p-16">
            <form onSubmit={handleSubmit} className="space-y-6 h-full flex flex-col justify-center">
              ...
              <motion.button 
                ...
                disabled={loading} 
                type="submit" 
                className="w-full py-5 rounded-2xl text-white font-bold text-lg bg-gradient-to-r from-[#0F172A] to-[#3a1528] shadow-lg disabled:opacity-70 transition-all flex justify-center items-center gap-2 mt-4"
              >
                {loading ? 'Sending...' : (
                  <>

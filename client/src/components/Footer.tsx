    ...
    <footer className="relative bg-[#0F172A] text-white overflow-hidden pt-32 pb-12">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="border-b border-white/10 pb-20 mb-20">
          ...
          <a href="#volunteer" className="inline-flex items-center gap-4 text-2xl md:text-4xl font-bold border-b-4 border-white/30 hover:border-[#E11D48] pb-2 transition-colors group">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-14 h-14 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center">
                <Heart size={28} className="fill-[#E11D48] text-[#E11D48]" />
              </div>
            ...
            <div className="flex gap-4 mt-auto">
              {[
                ...
                <a key={i} href={social.href} className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#E11D48] hover:border-[#E11D48] transition-all duration-300 hover:scale-110 hover:-translate-y-1">
                  {social.icon}
                </a>
              ))}
            </div>
          ...
          <div className="md:col-span-3 lg:col-span-2 lg:col-start-7">
            ...
            <div className="flex flex-col gap-4">
              {['Home', 'About Us', 'Programs', 'Impact', 'Volunteer'].map((link) => (
                <a key={link} href={`#${link.toLowerCase().replace(' ', '')}`} className="text-lg font-bold text-white hover:text-[#E11D48] transition-colors w-fit">{link}</a>
              ))}
            </div>
          </div>
          ...
          <div className="md:col-span-4 lg:col-span-3 lg:col-start-10">
            ...
            <div className="flex flex-col gap-6">
              <div>
                ...
                <a href="mailto:shecanfoundation.ngo@gmail.com" className="text-lg font-bold hover:text-[#E11D48] transition-colors break-words">shecanfoundation.ngo@gmail.com</a>
              </div>
              <div>

    ...
    <section className="relative min-h-[110vh] bg-[#FDFBF7] overflow-hidden flex items-center pt-24 pb-16">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Right Image Collage - Massive Dense Scatter */}
          <motion.div 
            style={{ y: y2 }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute top-[40%] left-[40%] -translate-x-1/2 -translate-y-1/2 w-64 h-[350px] z-30"
            >
            ...
            <motion.div 
              ...
              className="absolute top-[5%] right-[-5%] w-72 h-auto z-20"
            >
            ...
            <motion.div 
              ...
              className="absolute top-[10%] left-[-10%] w-56 h-auto z-20"
            >
            ...
            <motion.div 
              ...
              className="absolute top-[-5%] left-[30%] w-48 h-auto z-10"
            >
              <div className="w-full p-2 bg-white rounded-[1.5rem] shadow-xl border border-gray-100 rotate-12 hover:rotate-6 transition-transform duration-500">
                <ImagePlaceholder 
                  label="HERO 4"
            ...
            <motion.div 
              ...
              className="absolute top-[35%] right-[-15%] w-40 h-auto z-40"
            >
              <div className="w-full p-1.5 bg-white rounded-2xl shadow-xl border border-gray-100 rotate-[-8deg] hover:rotate-0 transition-transform duration-500">
                <ImagePlaceholder 
                  label="HERO 5"
            ...
            <motion.div 
              ...
              className="absolute top-[45%] left-[-15%] w-44 h-auto z-40"
            >
              <div className="w-full p-2 bg-white rounded-2xl shadow-2xl border border-gray-100 rotate-6 hover:rotate-12 transition-transform duration-500">
                <ImagePlaceholder 
                  label="HERO 6"
            ...
            <motion.div 
              ...
              className="absolute bottom-[5%] left-[0%] w-52 h-auto z-20"
            >
              <div className="w-full p-2 bg-white rounded-[1.5rem] shadow-xl border border-gray-100 -rotate-12 hover:-rotate-6 transition-transform duration-500">
                <ImagePlaceholder 
                  label="HERO 7"
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1, delay: 0.9, type: "spring" }}
              className="absolute bottom-[-10%] left-[35%] w-60 h-auto z-40"
            >
              <div className="w-full p-2 bg-white rounded-[1.5rem] shadow-2xl border border-gray-100 rotate-3 hover:-rotate-3 transition-transform duration-500">
                <ImagePlaceholder 
                  label="HERO 8"
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, x: 0, y: 0 }}
              transition={{ duration: 1, delay: 0.7, type: "spring" }}
              className="absolute bottom-[10%] right-[0%] w-56 h-auto z-30"
            >
              <div className="w-full p-2 bg-white rounded-[1.5rem] shadow-2xl border border-gray-100 -rotate-6 hover:rotate-0 transition-transform duration-500">
                <ImagePlaceholder 
                  label="HERO 9"

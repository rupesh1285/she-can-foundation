...
export const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-32 pb-24 overflow-hidden bg-[#fafafa]">
      ...
      <motion.div 
        ...
        className="absolute top-0 right-0 w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] bg-gradient-to-br from-[#E91E8C]/15 to-[#FF6BB5]/15 blur-[120px] -translate-y-1/2 translate-x-1/4 pointer-events-none" 
      />
      ...
      <motion.div 
        ...
        className="absolute bottom-0 left-0 w-[50vw] h-[50vw] max-w-[700px] max-h-[700px] bg-gradient-to-tr from-[#FF6BB5]/15 to-[#FFD6EC]/25 blur-[100px] translate-y-1/3 -translate-x-1/4 pointer-events-none" 
      />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-12">
          ...
          <div className="lg:w-[55%] text-center lg:text-left pt-10 lg:pt-0">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/40 backdrop-blur-2xl shadow-[inset_0_1px_3px_rgba(255,255,255,1),0_4px_20px_-5px_rgba(0,0,0,0.05)] border border-white/50 text-[#1A1A2E] font-bold text-xs uppercase tracking-[0.2em] mb-10"
            >
            ...
            <h1 className="text-6xl md:text-7xl lg:text-[5.5rem] font-bold font-serif text-[#1A1A2E] leading-[0.95] tracking-tighter mb-8">
              ...
              <motion.span custom={4} initial="hidden" animate="visible" variants={textVariants} className="block text-transparent bg-clip-text bg-gradient-to-r from-[#E91E8C] via-[#FF6BB5] to-[#E91E8C] bg-[length:200%_auto] animate-gradient mt-2 pb-2">
                Transforming Lives.
              </motion.span>
            </h1>
            ...
            <motion.div custom={6} initial="hidden" animate="visible" variants={textVariants} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#volunteer" 
                className="w-full sm:w-auto px-10 py-5 rounded-full text-white font-bold bg-[#1A1A2E] shadow-[0_20px_40px_-10px_rgba(26,26,46,0.5)] hover:shadow-[0_20px_40px_-10px_rgba(233,30,140,0.5)] hover:bg-[#E91E8C] transition-all duration-300 text-lg flex items-center justify-center gap-3 group"
              >
                Volunteer With Us
              ...
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#programs" 
                className="w-full sm:w-auto px-10 py-5 rounded-full text-[#1A1A2E] font-bold bg-white/60 backdrop-blur-xl shadow-[inset_0_1px_2px_rgba(255,255,255,1),0_10px_20px_-10px_rgba(0,0,0,0.05)] border border-white/40 hover:bg-white transition-all text-lg flex items-center justify-center"
              >
                Our Programs
              </motion.a>
            </motion.div>
          ...
          <div className="lg:w-[45%] relative w-full aspect-[4/5] max-w-[550px] mx-auto mt-12 lg:mt-0 perspective-1000">
            ...
            >
              <div className="absolute inset-0 bg-[#E91E8C]/20 mix-blend-overlay z-10"></div>
              <img 
            ...
            >
              <div className="w-14 h-14 rounded-[1.2rem] bg-gradient-to-br from-[#E91E8C] to-[#FF6BB5] flex items-center justify-center text-white shadow-[0_10px_20px_-10px_rgba(233,30,140,0.6)]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                </svg>
              </div>
              <div>
                <p className="text-3xl font-bold font-serif text-[#1A1A2E] tracking-tight">8.4k+</p>

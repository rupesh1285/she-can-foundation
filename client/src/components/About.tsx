    ...
    <section id="about" className="py-40 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-20 lg:gap-32">
          ...
          >
            {/* Soft backdrop glow */}
            <div className="absolute inset-0 bg-[#FF4500]/20 rounded-[3rem] blur-3xl transform -translate-x-10 translate-y-10 -z-10"></div>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex -space-x-4">
                    ...
                    <div className="w-12 h-12 rounded-full border-[3px] border-white bg-gradient-to-br from-[#FF4500] to-[#FF6BB5] text-white flex items-center justify-center text-xs font-black shadow-sm">+2k</div>
                  </div>
                </div>
          ...
          >
            <div className="inline-flex items-center gap-3 px-1 mb-8">
              ...
              <span className="text-[10px] font-bold tracking-[0.3em] text-[#FF4500] uppercase">The Foundation</span>
            </div>
            ...
            <h2 className="text-5xl md:text-6xl lg:text-[4.5rem] font-bold font-serif text-[#1A1A2E] mb-8 leading-[1.05] tracking-tighter">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF4500] to-[#FF6BB5]">Empowerment.</span>
            </h2>
            ...
            <div className="space-y-6 mb-12">
              <div className="flex gap-6 items-start p-8 rounded-[2rem] bg-[#fcfcfc] shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_10px_20px_-10px_rgba(0,0,0,0.02)] border border-gray-100 group hover:bg-white transition-colors duration-500">
                <div className="w-16 h-16 rounded-[1.2rem] bg-[#FFD6EC]/50 flex items-center justify-center text-[#FF4500] shrink-0 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500">
                  <BookOpen size={28} />
                </div>
                <div>

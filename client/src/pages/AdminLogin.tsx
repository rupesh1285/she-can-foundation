    ...
    <div className="min-h-screen bg-[#FFD6EC]/30 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-[2rem] shadow-xl p-8">
        <div className="flex flex-col items-center mb-8">
          <Heart className="text-[#E91E8C] mb-4" fill="#E91E8C" size={48} />
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#E91E8C] bg-gray-50" 
            />
          </div>
          <div>
          ...
          <button 
            disabled={loading} 
            type="submit" 
            className="w-full py-4 rounded-xl text-white font-bold bg-gradient-to-r from-[#E91E8C] to-[#FF6BB5] hover:shadow-lg disabled:opacity-70 transition-all"
          >

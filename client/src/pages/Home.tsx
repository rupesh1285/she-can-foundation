    ...
    <div className="w-full">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-xl">
              ...
              <Link to="/stories" className="text-[#FF4500] font-bold hover:underline">Read full story &rarr;</Link>
            </div>
            <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-xl">
              <ImagePlaceholder 
      ...
      <section className="py-32 bg-[#FF4500] text-white text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-12 text-[#FFDED6]">Join our community of changemakers and help us create a world where every woman has the opportunity to thrive and succeed.</p>
          <Link to="/volunteer" className="inline-block px-12 py-5 bg-white text-[#FF4500] font-bold rounded-full text-xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all">
            Join Our Community
          </Link>
        </div>
      </section>

    ...
    <div className="pt-24 bg-[#FDFBF7] min-h-screen">
      ...
      <section className="container mx-auto px-4 md:px-8 pb-24 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-[2rem] border border-[#FF4500]/10 shadow-xl text-center">
            <div className="w-16 h-16 bg-[#FFDED6] text-[#FF4500] rounded-full flex items-center justify-center mx-auto mb-6">
              <Heart size={32} />
            </div>
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-[#FF4500]/10 shadow-xl text-center scale-105 border-b-4 border-b-[#FF4500]">
            <div className="w-16 h-16 bg-[#FF4500] text-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_20px_rgba(225,29,72,0.4)]">
              <ShieldCheck size={32} />
            </div>
        ...
        <div className="text-center bg-white p-12 rounded-[3rem] shadow-2xl border border-gray-100 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#FFDED6] rounded-full blur-3xl opacity-50 translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
          ...
          <a 
            ...
            className="relative z-10 inline-block px-16 py-6 bg-gradient-to-r from-[#FF4500] to-[#FF8C66] text-white font-bold rounded-full text-2xl shadow-[0_20px_40px_-10px_rgba(225,29,72,0.5)] hover:shadow-[0_25px_50px_-10px_rgba(225,29,72,0.7)] hover:-translate-y-1 transition-all"
          >
            Donate Now
          </a>
